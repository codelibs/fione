...
def init(language, output_dir, clear_dir=False):
    """
    ...
    correctness.
      ...
      :param output_dir -- folder where the bindings files will be generated. If the folder does
        not exist, it will be created. This folder is relative to ../src/main/. The user may
    ...
    default_output_dir = os.path.abspath(this_module_dir + "/../src/main/" + output_dir)
