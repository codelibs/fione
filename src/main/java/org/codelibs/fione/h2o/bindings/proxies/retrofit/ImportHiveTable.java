...
public interface ImportHiveTable {
    ...
    Call<JobV3> importHiveTable(@Field("database") String database, @Field("table") String table,
            @Field("partitions") String[][] partitions, @Field("allow_multi_format") boolean allow_multi_format,
