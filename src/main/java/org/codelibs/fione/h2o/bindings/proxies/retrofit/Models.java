...
public interface Models {
    ...
    Call<StreamingSchema> fetchBinaryModel(@Path("model_id") String model_id, @Query("preview") boolean preview,
            @Query("find_compatible_frames") boolean find_compatible_frames,
            @Query("export_cross_validation_predictions") boolean export_cross_validation_predictions,
            @Query("_exclude_fields") String _exclude_fields);
    ...
    Call<ModelsV3> uploadModel(@Path("model_id") String model_id, @Field("dir") String dir, @Field("force") boolean force,
            @Field("_exclude_fields") String _exclude_fields);
