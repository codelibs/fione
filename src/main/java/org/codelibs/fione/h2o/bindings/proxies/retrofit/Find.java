...
import org.codelibs.fione.h2o.bindings.pojos.FindV3;
...
public interface Find {
     ...
     */
    @GET("/3/Find")
    Call<FindV3> find(@Query("key") FrameV3 key, @Query("column") String column, @Query("row") long row, @Query("match") String match,
            @Query("_exclude_fields") String _exclude_fields);

    @GET("/3/Find")
    Call<FindV3> find(@Query("key") FrameV3 key, @Query("row") long row);
