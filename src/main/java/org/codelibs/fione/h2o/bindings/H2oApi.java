        ...
        public ModelBuilderSchema deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    ...
                    case "infogram":
                        return context.deserialize(json, InfogramV3.class);
                    case "targetencoder":
                    ...
                    case "extendedisolationforest":
                        return context.deserialize(json, ExtendedIsolationForestV3.class);
                    case "aggregator":
                    ...
                    case "gam":
                        return context.deserialize(json, GAMV3.class);
                    case "anovaglm":
                        return context.deserialize(json, ANOVAGLMV3.class);
                    case "psvm":
                        return context.deserialize(json, PSVMV3.class);
                    case "rulefit":
                        return context.deserialize(json, RuleFitV3.class);
                    case "upliftdrf":
                        return context.deserialize(json, UpliftDRFV3.class);
                    case "modelselection":
                        return context.deserialize(json, ModelSelectionV3.class);
                    default:
        ...
        public ModelSchemaBaseV3 deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    ...
                    case "infogram":
                        return context.deserialize(json, InfogramModelV3.class);
                    case "targetencoder":
                    ...
                    case "extendedisolationforest":
                        return context.deserialize(json, ExtendedIsolationForestModelV3.class);
                    case "aggregator":
                    ...
                    case "gam":
                        return context.deserialize(json, GAMModelV3.class);
                    case "anovaglm":
                        return context.deserialize(json, ANOVAGLMModelV3.class);
                    case "psvm":
                        return context.deserialize(json, PSVMModelV3.class);
                    case "rulefit":
                        return context.deserialize(json, RuleFitModelV3.class);
                    case "upliftdrf":
                        return context.deserialize(json, UpliftDRFModelV3.class);
                    case "modelselection":
                        return context.deserialize(json, ModelSelectionModelV3.class);
                    default:
                        throw new JsonParseException("Unable to deserialize model of type " + algo);
                    }
                }
        ...
        public ModelOutputSchemaV3 deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    ...
                    case "infogram":
                        return context.deserialize(json, InfogramModelOutputV3.class);
                    case "targetencoder":
                    ...
                    case "extendedisolationforest":
                        return context.deserialize(json, ExtendedIsolationForestModelOutputV3.class);
                    case "aggregator":
                    ...
                    case "gam":
                        return context.deserialize(json, GAMModelOutputV3.class);
                    case "anovaglm":
                        return context.deserialize(json, ANOVAGLMModelOutputV3.class);
                    case "psvm":
                        return context.deserialize(json, PSVMModelOutputV3.class);
                    case "rulefit":
                        return context.deserialize(json, RuleFitModelOutputV3.class);
                    case "upliftdrf":
                        return context.deserialize(json, UpliftDRFModelOutputV3.class);
                    case "modelselection":
                        return context.deserialize(json, ModelSelectionModelOutputV3.class);
                    default:
                        throw new JsonParseException("Unable to deserialize model of type " + algo);
                    }
                }
        ...
        public ModelParametersSchemaV3 deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    ...
                    case "infogram":
                        return context.deserialize(json, InfogramParametersV3.class);
                    case "targetencoder":
                    ...
                    case "extendedisolationforest":
                        return context.deserialize(json, ExtendedIsolationForestParametersV3.class);
                    case "aggregator":
                    ...
                    case "gam":
                        return context.deserialize(json, GAMParametersV3.class);
                    case "anovaglm":
                        return context.deserialize(json, ANOVAGLMParametersV3.class);
                    case "psvm":
                        return context.deserialize(json, PSVMParametersV3.class);
                    case "rulefit":
                        return context.deserialize(json, RuleFitParametersV3.class);
                    case "upliftdrf":
                        return context.deserialize(json, UpliftDRFParametersV3.class);
                    case "modelselection":
                        return context.deserialize(json, ModelSelectionParametersV3.class);
                    default:
                        throw new JsonParseException("Unable to deserialize model of type " + algo);
                    }
                }
