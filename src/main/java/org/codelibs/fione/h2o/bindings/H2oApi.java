...
import org.codelibs.fione.h2o.bindings.proxies.retrofit.FeatureInteraction;
...
import org.codelibs.fione.h2o.bindings.proxies.retrofit.FriedmansPopescusH;
...
import org.codelibs.fione.h2o.bindings.proxies.retrofit.Recovery;
import org.codelibs.fione.h2o.bindings.proxies.retrofit.Sample;
import org.codelibs.fione.h2o.bindings.proxies.retrofit.SaveToHiveTable;
import org.codelibs.fione.h2o.bindings.proxies.retrofit.SessionProperties;
...
import org.codelibs.fione.h2o.bindings.proxies.retrofit.XGBoostExecutor;
...
public class H2oApi {
    ...
    public XGBoostV3 train_xgboost(final XGBoostParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainXgboost(params.ntrees, params.maxDepth, params.minRows, params.minChildWeight, params.learnRate, params.eta,
                params.sampleRate, params.subsample, params.colSampleRate, params.colsampleBylevel, params.colSampleRatePerTree,
                params.colsampleBytree, params.colsampleBynode, params.monotoneConstraints, params.maxAbsLeafnodePred, params.maxDeltaStep,
                params.scoreTreeInterval, params.seed, params.minSplitImprovement, params.gamma, params.nthread, params.buildTreeOneNode,
                params.saveMatrixDirectory, params.calibrateModel, keyToString(params.calibrationFrame), params.maxBins, params.maxLeaves,
                params.treeMethod, params.growPolicy, params.booster, params.regLambda, params.regAlpha, params.quietMode,
                params.sampleType, params.normalizeType, params.rateDrop, params.oneDrop, params.skipDrop, params.dmatrixType,
                params.backend, params.gpuId, params.interactionConstraints, params.scalePosWeight, keyToString(params.modelId),
                ...
                params.stoppingMetric, params.stoppingTolerance, params.gainsliftBins, params.customMetricFunc,
                params.customDistributionFunc, params.exportCheckpointsDir, params.aucType).execute().body();
    }
    ...
    public XGBoostV3 validate_xgboost(final XGBoostParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersXgboost(params.ntrees, params.maxDepth, params.minRows, params.minChildWeight, params.learnRate,
    ...
    public XGBoostV3 grid_search_xgboost_resume(final XGBoostParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeXgboost(params.ntrees, params.maxDepth, params.minRows, params.minChildWeight, params.learnRate, params.eta,
                params.sampleRate, params.subsample, params.colSampleRate, params.colsampleBylevel, params.colSampleRatePerTree,
                params.colsampleBytree, params.colsampleBynode, params.monotoneConstraints, params.maxAbsLeafnodePred, params.maxDeltaStep,
                params.scoreTreeInterval, params.seed, params.minSplitImprovement, params.gamma, params.nthread, params.buildTreeOneNode,
                params.saveMatrixDirectory, params.calibrateModel, keyToString(params.calibrationFrame), params.maxBins, params.maxLeaves,
    ...
    public XGBoostExecRespV3 remote_xgb_init() throws IOException {
        final XGBoostExecutor s = getService(XGBoostExecutor.class);
        return s.init().execute().body();
    }

    public XGBoostExecRespV3 remote_xgb_init(final KeyV3 key, final String data) throws IOException {
        final XGBoostExecutor s = getService(XGBoostExecutor.class);
    ...
    public StreamingSchema remote_xgb_setup(final KeyV3 key, final String data) throws IOException {
        final XGBoostExecutor s = getService(XGBoostExecutor.class);
    ...
    public XGBoostExecRespV3 remote_xgb_update(final KeyV3 key, final String data) throws IOException {
        final XGBoostExecutor s = getService(XGBoostExecutor.class);
    ...
    public StreamingSchema remote_xgb_booster(final KeyV3 key, final String data) throws IOException {
        final XGBoostExecutor s = getService(XGBoostExecutor.class);
    ...
    public XGBoostExecRespV3 remote_xgb_cleanup(final KeyV3 key, final String data) throws IOException {
        final XGBoostExecutor s = getService(XGBoostExecutor.class);
    ...
    public Call<PersistS3CredentialsV3> setS3Credentials(final String secretKeyId, final String secretAccessKey,
        ...
        final PersistS3 s = getService(PersistS3.class);
        return s.setS3Credentials(secretKeyId, secretAccessKey, sessionToken);
    }
    ...
    public InfogramV3 train_infogram(final InfogramParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainInfogram(params.seed, params.standardize, keyToString(params.plugValues), params.maxIterations, params.prior,
                params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize, params.algorithm, params.algorithmParams,
                params.protectedColumns, params.totalInformationThreshold, params.netInformationThreshold, params.relevanceIndexThreshold,
                params.safetyIndexThreshold, params.dataFraction, params.topNFeatures, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
    ...
    public InfogramV3 validate_infogram(final InfogramParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersInfogram(params.seed, params.standardize, keyToString(params.plugValues), params.maxIterations,
                params.prior, params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize, params.algorithm,
                params.algorithmParams, params.protectedColumns, params.totalInformationThreshold, params.netInformationThreshold,
                params.relevanceIndexThreshold, params.safetyIndexThreshold, params.dataFraction, params.topNFeatures,
                ...
                params.stoppingRounds, params.maxRuntimeSecs, params.stoppingMetric, params.stoppingTolerance, params.gainsliftBins,
                params.customMetricFunc, params.customDistributionFunc, params.exportCheckpointsDir, params.aucType).execute().body();
    }
    ...
    public InfogramV3 grid_search_infogram(final InfogramParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainInfogram(params.seed, params.standardize, keyToString(params.plugValues), params.maxIterations, params.prior,
                params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize, params.algorithm, params.algorithmParams,
                params.protectedColumns, params.totalInformationThreshold, params.netInformationThreshold, params.relevanceIndexThreshold,
    ...
    public InfogramV3 grid_search_infogram_resume(final InfogramParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeInfogram(params.seed, params.standardize, keyToString(params.plugValues), params.maxIterations, params.prior,
                params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize, params.algorithm, params.algorithmParams,
                params.protectedColumns, params.totalInformationThreshold, params.netInformationThreshold, params.relevanceIndexThreshold,
                params.safetyIndexThreshold, params.dataFraction, params.topNFeatures, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
    ...
    public TargetEncoderV3 train_targetencoder(final TargetEncoderParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainTargetencoder(params.columnsToEncode, params.keepOriginalCategoricalColumns, params.blending, params.inflectionPoint,
                params.smoothing, params.dataLeakageHandling, params.noise, params.seed, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
    ...
    public TargetEncoderV3 validate_targetencoder(final TargetEncoderParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersTargetencoder(params.columnsToEncode, params.keepOriginalCategoricalColumns, params.blending,
                params.inflectionPoint, params.smoothing, params.dataLeakageHandling, params.noise, params.seed,
                keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds,
                params.keepCrossValidationModels, params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment,
                params.parallelizeCrossValidation, params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha,
                colToString(params.responseColumn), colToString(params.weightsColumn), colToString(params.offsetColumn),
    ...
    public TargetEncoderV3 grid_search_targetencoder_resume(final TargetEncoderParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeTargetencoder(params.columnsToEncode, params.keepOriginalCategoricalColumns, params.blending, params.inflectionPoint,
                params.smoothing, params.dataLeakageHandling, params.noise, params.seed, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
    ...
    public FrameKeyV3 target_encoder_transform(final TargetEncoderTransformParametersV3 params) throws IOException {
        final TargetEncoderTransform s = getService(TargetEncoderTransform.class);
        return s.transform(keyToString(params.model), keyToString(params.frame), params.asTraining, params.blending, params.inflectionPoint,
                params.smoothing, params.noise).execute().body();
    }
    ...
    public DeepLearningV3 train_deeplearning(final DeepLearningParametersV3 params) throws IOException {
        ...
        return s.trainDeeplearning(params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.activation, params.hidden, params.epochs, params.trainSamplesPerIteration,
                params.targetRatioCommToComp, params.seed, params.adaptiveRate, params.rho, params.epsilon, params.rate,
                params.rateAnnealing, params.rateDecay, params.momentumStart, params.momentumRamp, params.momentumStable,
    ...
    public DeepLearningV3 grid_search_deeplearning_resume(final DeepLearningParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeDeeplearning(params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.activation, params.hidden, params.epochs, params.trainSamplesPerIteration,
                params.targetRatioCommToComp, params.seed, params.adaptiveRate, params.rho, params.epsilon, params.rate,
                params.rateAnnealing, params.rateDecay, params.momentumStart, params.momentumRamp, params.momentumStable,
                params.nesterovAcceleratedGradient, params.inputDropoutRatio, params.hiddenDropoutRatios, params.l1, params.l2,
    ...
    public GLMV3 train_glm(final GLMParametersV3 params) throws IOException {
        ...
        return s.trainGlm(params.seed, params.family, params.randFamily, params.tweedieVariancePower, params.tweedieLinkPower, params.theta,
                params.solver, params.alpha, params.lambda, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.scoreIterationInterval, params.standardize, params.coldStart, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.maxIterations, params.betaEpsilon, params.objectiveEpsilon,
                params.gradientEpsilon, params.objReg, params.link, params.randLink, params.startval, params.randomColumns, params.calcLike,
                params.intercept, params.hglm, params.prior, params.lambdaMinRatio, keyToString(params.betaConstraints),
                params.maxActivePredictors, params.interactions, params.interactionPairs, params.balanceClasses,
                params.classSamplingFactors, params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.computePValues,
                params.removeCollinearColumns, params.generateScoringHistory, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
    ...
    public GLMV3 grid_search_glm_resume(final GLMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeGlm(params.seed, params.family, params.randFamily, params.tweedieVariancePower, params.tweedieLinkPower,
                params.theta, params.solver, params.alpha, params.lambda, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.scoreIterationInterval, params.standardize, params.coldStart, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.maxIterations, params.betaEpsilon, params.objectiveEpsilon,
                params.gradientEpsilon, params.objReg, params.link, params.randLink, params.startval, params.randomColumns, params.calcLike,
    ...
    public GLRMV3 train_glrm(final GLRMParametersV3 params) throws IOException {
        ...
        return s.trainGlrm(params.transform, params.k, params.loss, params.multiLoss, params.lossByCol, params.lossByColIdx, params.period,
                ...
                keyToString(params.userX), params.loadingName, params.representationName, params.expandUserY, params.imputeOriginal,
                ...
                params.stoppingTolerance, params.gainsliftBins, params.customMetricFunc, params.customDistributionFunc,
                params.exportCheckpointsDir, params.aucType).execute().body();
    }
    ...
    public GLRMV3 validate_glrm(final GLRMParametersV3 params) throws IOException {
        ...
        return s.validate_parametersGlrm(params.transform, params.k, params.loss, params.multiLoss, params.lossByCol, params.lossByColIdx,
                ...
                keyToString(params.userY), keyToString(params.userX), params.loadingName, params.representationName, params.expandUserY,
                params.imputeOriginal, params.recoverSvd, keyToString(params.modelId), keyToString(params.trainingFrame),
     ...
     */
    public GLRMV3 grid_search_glrm_resume(final int k) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeGlrm(k).execute().body();
    }

    public GLRMV3 grid_search_glrm_resume(final GLRMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeGlrm(params.transform, params.k, params.loss, params.multiLoss, params.lossByCol, params.lossByColIdx, params.period,
                params.regularizationX, params.regularizationY, params.gammaX, params.gammaY, params.maxIterations, params.maxUpdates,
                params.initStepSize, params.minStepSize, params.seed, params.init, params.svdMethod, keyToString(params.userY),
                keyToString(params.userX), params.loadingName, params.representationName, params.expandUserY, params.imputeOriginal,
                params.recoverSvd, keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame),
    ...
    public KMeansV3 train_kmeans(final KMeansParametersV3 params) throws IOException {
        ...
        return s.trainKmeans(keyToString(params.userPoints), params.maxIterations, params.standardize, params.seed, params.init,
                params.estimateK, params.clusterSizeConstraints, params.k, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
    ...
    public KMeansV3 validate_kmeans(final KMeansParametersV3 params) throws IOException {
        ...
        return s.validate_parametersKmeans(keyToString(params.userPoints), params.maxIterations, params.standardize, params.seed,
                params.init, params.estimateK, params.clusterSizeConstraints, params.k, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
    ...
    public KMeansV3 grid_search_kmeans_resume(final KMeansParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeKmeans(keyToString(params.userPoints), params.maxIterations, params.standardize, params.seed, params.init,
                params.estimateK, params.clusterSizeConstraints, params.k, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
    ...
    public NaiveBayesV3 train_naivebayes(final NaiveBayesParametersV3 params) throws IOException {
        ...
        return s.trainNaivebayes(params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.laplace, params.minSdev, params.epsSdev, params.minProb, params.epsProb,
                params.computeMetrics, params.seed, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
    ...
    public NaiveBayesV3 grid_search_naivebayes_resume(final NaiveBayesParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeNaivebayes(params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.laplace, params.minSdev, params.epsSdev, params.minProb, params.epsProb,
                params.computeMetrics, params.seed, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
     ...
     */
    public PCAV3 grid_search_pca_resume(final int k) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumePca(k).execute().body();
    }

    public PCAV3 grid_search_pca_resume(final PCAParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumePca(params.transform, params.pcaMethod, params.pcaImpl, params.k, params.maxIterations, params.seed,
                params.useAllFactorLevels, params.computeMetrics, params.imputeMissing, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
    ...
    public SVDV99 grid_search_svd_resume(final SVDParametersV99 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeSvd(params.transform, params.svdMethod, params.nv, params.maxIterations, params.seed, params.keepU, params.uName,
                params.useAllFactorLevels, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
    ...
    public DRFV3 train_drf(final DRFParametersV3 params) throws IOException {
        ...
        return s.trainDrf(params.mtries, params.binomialDoubleTrees, params.sampleRate, params.balanceClasses, params.classSamplingFactors,
                params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins,
                params.nbinsTopLevel, params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
                params.histogramType, params.calibrateModel, keyToString(params.calibrationFrame), params.checkConstantResponse,
                keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds,
                params.keepCrossValidationModels, params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment,
                params.parallelizeCrossValidation, params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha,
                colToString(params.responseColumn), colToString(params.weightsColumn), colToString(params.offsetColumn),
    ...
    public DRFV3 validate_drf(final DRFParametersV3 params) throws IOException {
        ...
        return s.validate_parametersDrf(params.mtries, params.binomialDoubleTrees, params.sampleRate, params.balanceClasses,
                params.classSamplingFactors, params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth,
    ...
    public DRFV3 grid_search_drf_resume(final DRFParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeDrf(params.mtries, params.binomialDoubleTrees, params.sampleRate, params.balanceClasses, params.classSamplingFactors,
                params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins,
                params.nbinsTopLevel, params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
                params.histogramType, params.calibrateModel, keyToString(params.calibrationFrame), params.checkConstantResponse,
    ...
    public GBMV3 train_gbm(final GBMParametersV3 params) throws IOException {
        ...
        return s.trainGbm(params.learnRate, params.learnRateAnnealing, params.sampleRate, params.colSampleRate, params.monotoneConstraints,
                params.maxAbsLeafnodePred, params.predNoiseBandwidth, params.interactionConstraints, params.balanceClasses,
                params.classSamplingFactors, params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth,
                params.minRows, params.nbins, params.nbinsTopLevel, params.nbinsCats, params.r2Stopping, params.seed,
                params.buildTreeOneNode, params.sampleRatePerClass, params.colSampleRatePerTree, params.colSampleRateChangePerLevel,
                params.scoreTreeInterval, params.minSplitImprovement, params.histogramType, params.calibrateModel,
    ...
    public GBMV3 validate_gbm(final GBMParametersV3 params) throws IOException {
        ...
        return s.validate_parametersGbm(params.learnRate, params.learnRateAnnealing, params.sampleRate, params.colSampleRate,
                params.monotoneConstraints, params.maxAbsLeafnodePred, params.predNoiseBandwidth, params.interactionConstraints,
                params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize, params.maxConfusionMatrixSize,
                params.ntrees, params.maxDepth, params.minRows, params.nbins, params.nbinsTopLevel, params.nbinsCats, params.r2Stopping,
                params.seed, params.buildTreeOneNode, params.sampleRatePerClass, params.colSampleRatePerTree,
                params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement, params.histogramType,
                params.calibrateModel, keyToString(params.calibrationFrame), params.checkConstantResponse, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
    ...
    public GBMV3 grid_search_gbm_resume(final GBMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeGbm(params.learnRate, params.learnRateAnnealing, params.sampleRate, params.colSampleRate, params.monotoneConstraints,
                params.maxAbsLeafnodePred, params.predNoiseBandwidth, params.interactionConstraints, params.balanceClasses,
                params.classSamplingFactors, params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth,
                params.minRows, params.nbins, params.nbinsTopLevel, params.nbinsCats, params.r2Stopping, params.seed,
                params.buildTreeOneNode, params.sampleRatePerClass, params.colSampleRatePerTree, params.colSampleRateChangePerLevel,
    ...
    public IsolationForestV3 train_isolationforest(final IsolationForestParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainIsolationforest(params.sampleSize, params.sampleRate, params.mtries, params.contamination,
                colToString(params.validationResponseColumn), params.balanceClasses, params.classSamplingFactors,
                params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins,
                params.nbinsTopLevel, params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
                params.histogramType, params.calibrateModel, keyToString(params.calibrationFrame), params.checkConstantResponse,
    ...
    public IsolationForestV3 validate_isolationforest(final IsolationForestParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersIsolationforest(params.sampleSize, params.sampleRate, params.mtries, params.contamination,
                colToString(params.validationResponseColumn), params.balanceClasses, params.classSamplingFactors,
                params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins,
                params.nbinsTopLevel, params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
    ...
    public IsolationForestV3 grid_search_isolationforest_resume(final IsolationForestParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeIsolationforest(params.sampleSize, params.sampleRate, params.mtries, params.contamination,
                colToString(params.validationResponseColumn), params.balanceClasses, params.classSamplingFactors,
                params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins,
                params.nbinsTopLevel, params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
    ...
    public ExtendedIsolationForestV3 train_extendedisolationforest(final ExtendedIsolationForestParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainExtendedisolationforest(params.ntrees, params.sampleSize, params.extensionLevel, params.seed,
                keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds,
                params.keepCrossValidationModels, params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment,
                params.parallelizeCrossValidation, params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha,
                colToString(params.responseColumn), colToString(params.weightsColumn), colToString(params.offsetColumn),
    ...
    public ExtendedIsolationForestV3 validate_extendedisolationforest(final ExtendedIsolationForestParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersExtendedisolationforest(params.ntrees, params.sampleSize, params.extensionLevel, params.seed,
                keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds,
                params.keepCrossValidationModels, params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment,
                params.parallelizeCrossValidation, params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha,
                colToString(params.responseColumn), colToString(params.weightsColumn), colToString(params.offsetColumn),
    ...
    public ExtendedIsolationForestV3 grid_search_extendedisolationforest(final ExtendedIsolationForestParametersV3 params)
            throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainExtendedisolationforest(params.ntrees, params.sampleSize, params.extensionLevel, params.seed,
                keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds,
    ...
    public ExtendedIsolationForestV3 grid_search_extendedisolationforest_resume(final ExtendedIsolationForestParametersV3 params)
            throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeExtendedisolationforest(params.ntrees, params.sampleSize, params.extensionLevel, params.seed,
                keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds,
                params.keepCrossValidationModels, params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment,
                params.parallelizeCrossValidation, params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha,
                colToString(params.responseColumn), colToString(params.weightsColumn), colToString(params.offsetColumn),
    ...
    public AggregatorV99 grid_search_aggregator_resume(final AggregatorParametersV99 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeAggregator(params.transform, params.pcaMethod, params.k, params.maxIterations, params.targetNumExemplars,
                params.relTolNumExemplars, params.seed, params.useAllFactorLevels, params.saveMappingFrame,
                params.numIterationWithoutNewExemplar, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
    ...
    public Word2VecV3 grid_search_word2vec_resume(final Word2VecParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeWord2vec(params.vecSize, params.windowSize, params.sentSampleRate, params.normModel, params.epochs,
                params.minWordFreq, params.initLearningRate, params.wordModel, keyToString(params.preTrained), keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
     ...
     */
    public StackedEnsembleV99 train_stackedensemble(final KeyV3[] baseModels) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
    ...
    public StackedEnsembleV99 train_stackedensemble(final StackedEnsembleParametersV99 params) throws IOException {
        ...
        return s.trainStackedensemble(keyArrayToStringArray(params.baseModels), params.metalearnerAlgorithm, params.metalearnerNfolds,
                params.metalearnerFoldAssignment, colToString(params.metalearnerFoldColumn), params.metalearnerTransform,
                params.keepLeveloneFrame, params.metalearnerParams, keyToString(params.blendingFrame), params.seed,
                params.scoreTrainingSamples, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
     ...
     */
    public StackedEnsembleV99 validate_stackedensemble(final KeyV3[] baseModels) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
    ...
    public StackedEnsembleV99 validate_stackedensemble(final StackedEnsembleParametersV99 params) throws IOException {
        ...
        return s.validate_parametersStackedensemble(keyArrayToStringArray(params.baseModels), params.metalearnerAlgorithm,
                ...
                params.metalearnerTransform, params.keepLeveloneFrame, params.metalearnerParams, keyToString(params.blendingFrame),
                params.seed, params.scoreTrainingSamples, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
     ...
     */
    public StackedEnsembleV99 grid_search_stackedensemble(final KeyV3[] baseModels) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainStackedensemble(keyArrayToStringArray(baseModels)).execute().body();
    }
     ...
     */
    public StackedEnsembleV99 grid_search_stackedensemble_resume(final KeyV3[] baseModels) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeStackedensemble(keyArrayToStringArray(baseModels)).execute().body();
    }

    public StackedEnsembleV99 grid_search_stackedensemble_resume(final StackedEnsembleParametersV99 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeStackedensemble(keyArrayToStringArray(params.baseModels), params.metalearnerAlgorithm, params.metalearnerNfolds,
                params.metalearnerFoldAssignment, colToString(params.metalearnerFoldColumn), params.metalearnerTransform,
                params.keepLeveloneFrame, params.metalearnerParams, keyToString(params.blendingFrame), params.seed,
                params.scoreTrainingSamples, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
    ...
    public CoxPHV3 train_coxph(final CoxPHParametersV3 params) throws IOException {
        ...
        return s.trainCoxph(colToString(params.startColumn), colToString(params.stopColumn), params.stratifyBy, params.ties, params.init,
                ...
                params.useAllFactorLevels, params.singleNodeMode, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
    ...
    public CoxPHV3 grid_search_coxph_resume(final CoxPHParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeCoxph(colToString(params.startColumn), colToString(params.stopColumn), params.stratifyBy, params.ties, params.init,
                params.lreMin, params.maxIterations, params.interactionsOnly, params.interactions, params.interactionPairs,
                params.useAllFactorLevels, params.singleNodeMode, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
    ...
    public GenericV3 grid_search_generic_resume(final GenericParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeGeneric(params.path, keyToString(params.modelKey), keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
     ...
     * Train a GAM model.
     */
    public GAMV3 train_gam(final String[][] gamColumns) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainGam(gamColumns).execute().body();
    }

    public GAMV3 train_gam(final GAMParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainGam(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower, params.theta, params.solver,
                params.alpha, params.lambda, params.startval, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.standardize, params.missingValuesHandling, keyToString(params.plugValues), params.nonNegative, params.maxIterations,
                params.betaEpsilon, params.objectiveEpsilon, params.gradientEpsilon, params.objReg, params.link, params.intercept,
                params.prior, params.coldStart, params.lambdaMinRatio, keyToString(params.betaConstraints), params.maxActivePredictors,
                params.interactions, params.interactionPairs, params.balanceClasses, params.classSamplingFactors,
                params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.computePValues, params.removeCollinearColumns,
                params.numKnots, params.splineOrders, params.gamColumns, params.scale, params.bs, params.keepGamCols,
                params.standardizeTpGamCols, params.scaleTpPenaltyMat, params.knotIds, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
     ...
     */
    public GAMV3 validate_gam(final String[][] gamColumns) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersGam(gamColumns).execute().body();
    }

    public GAMV3 validate_gam(final GAMParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersGam(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower, params.theta,
                params.solver, params.alpha, params.lambda, params.startval, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.standardize, params.missingValuesHandling, keyToString(params.plugValues), params.nonNegative, params.maxIterations,
                params.betaEpsilon, params.objectiveEpsilon, params.gradientEpsilon, params.objReg, params.link, params.intercept,
                params.prior, params.coldStart, params.lambdaMinRatio, keyToString(params.betaConstraints), params.maxActivePredictors,
                params.interactions, params.interactionPairs, params.balanceClasses, params.classSamplingFactors,
     ...
     */
    public GAMV3 grid_search_gam(final String[][] gamColumns) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainGam(gamColumns).execute().body();
    }

    public GAMV3 grid_search_gam(final GAMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainGam(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower, params.theta, params.solver,
                params.alpha, params.lambda, params.startval, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.standardize, params.missingValuesHandling, keyToString(params.plugValues), params.nonNegative, params.maxIterations,
     ...
     */
    public GAMV3 grid_search_gam_resume(final String[][] gamColumns) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeGam(gamColumns).execute().body();
    }

    public GAMV3 grid_search_gam_resume(final GAMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeGam(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower, params.theta, params.solver,
                params.alpha, params.lambda, params.startval, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.standardize, params.missingValuesHandling, keyToString(params.plugValues), params.nonNegative, params.maxIterations,
                params.betaEpsilon, params.objectiveEpsilon, params.gradientEpsilon, params.objReg, params.link, params.intercept,
                params.prior, params.coldStart, params.lambdaMinRatio, keyToString(params.betaConstraints), params.maxActivePredictors,
    ...
    public ANOVAGLMV3 train_anovaglm(final ANOVAGLMParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainAnovaglm(params.seed, params.standardize, params.family, params.tweedieVariancePower, params.tweedieLinkPower,
                params.theta, params.alpha, params.lambda, params.lambdaSearch, params.solver, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.computePValues, params.maxIterations, params.link, params.prior,
                params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize, params.highestInteractionTerm, params.type,
                params.earlyStopping, params.saveTransformedFramekeys, params.nparallelism, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
    ...
    public ANOVAGLMV3 validate_anovaglm(final ANOVAGLMParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersAnovaglm(params.seed, params.standardize, params.family, params.tweedieVariancePower,
                params.tweedieLinkPower, params.theta, params.alpha, params.lambda, params.lambdaSearch, params.solver,
                params.missingValuesHandling, keyToString(params.plugValues), params.nonNegative, params.computePValues,
                params.maxIterations, params.link, params.prior, params.balanceClasses, params.classSamplingFactors,
                params.maxAfterBalanceSize, params.highestInteractionTerm, params.type, params.earlyStopping,
                params.saveTransformedFramekeys, params.nparallelism, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
    ...
    public ANOVAGLMV3 grid_search_anovaglm(final ANOVAGLMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainAnovaglm(params.seed, params.standardize, params.family, params.tweedieVariancePower, params.tweedieLinkPower,
                params.theta, params.alpha, params.lambda, params.lambdaSearch, params.solver, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.computePValues, params.maxIterations, params.link, params.prior,
    ...
    public ANOVAGLMV3 grid_search_anovaglm_resume(final ANOVAGLMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeAnovaglm(params.seed, params.standardize, params.family, params.tweedieVariancePower, params.tweedieLinkPower,
                params.theta, params.alpha, params.lambda, params.lambdaSearch, params.solver, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.computePValues, params.maxIterations, params.link, params.prior,
                params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize, params.highestInteractionTerm, params.type,
                params.earlyStopping, params.saveTransformedFramekeys, params.nparallelism, keyToString(params.modelId),
    ...
    public PSVMV3 grid_search_psvm_resume(final PSVMParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumePsvm(params.hyperParam, params.kernelType, params.gamma, params.rankRatio, params.positiveWeight,
                params.negativeWeight, params.disableTrainingMetrics, params.svThreshold, params.maxIterations, params.factThreshold,
                params.feasibleThreshold, params.surrogateGapThreshold, params.muFactor, params.seed, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
    ...
    public RuleFitV3 train_rulefit(final RuleFitParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainRulefit(params.seed, params.algorithm, params.minRuleLength, params.maxRuleLength, params.maxNumRules,
                params.modelType, params.ruleGenerationNtrees, params.removeDuplicates, params.lambda, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
                colToString(params.weightsColumn), colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment,
    ...
    public RuleFitV3 validate_rulefit(final RuleFitParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersRulefit(params.seed, params.algorithm, params.minRuleLength, params.maxRuleLength, params.maxNumRules,
                params.modelType, params.ruleGenerationNtrees, params.removeDuplicates, params.lambda, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
    ...
    public RuleFitV3 grid_search_rulefit(final RuleFitParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainRulefit(params.seed, params.algorithm, params.minRuleLength, params.maxRuleLength, params.maxNumRules,
                params.modelType, params.ruleGenerationNtrees, params.removeDuplicates, params.lambda, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
    ...
    public RuleFitV3 grid_search_rulefit_resume(final RuleFitParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeRulefit(params.seed, params.algorithm, params.minRuleLength, params.maxRuleLength, params.maxNumRules,
                params.modelType, params.ruleGenerationNtrees, params.removeDuplicates, params.lambda, keyToString(params.modelId),
                keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels,
                params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation,
                params.distribution, params.tweediePower, params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn),
     ...
     */
    public UpliftDRFV3 train_upliftdrf(final String treatmentColumn) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainUpliftdrf(treatmentColumn).execute().body();
    }

    public UpliftDRFV3 train_upliftdrf(final UpliftDRFParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainUpliftdrf(params.mtries, params.sampleRate, params.treatmentColumn, params.upliftMetric, params.auucType,
                params.auucNbins, params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins, params.nbinsTopLevel,
                params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
                params.histogramType, params.calibrateModel, keyToString(params.calibrationFrame), params.checkConstantResponse,
                keyToString(params.modelId), keyToString(params.trainingFrame), keyToString(params.validationFrame), params.nfolds,
                params.keepCrossValidationModels, params.keepCrossValidationPredictions, params.keepCrossValidationFoldAssignment,
     ...
     */
    public UpliftDRFV3 validate_upliftdrf(final String treatmentColumn) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersUpliftdrf(treatmentColumn).execute().body();
    }

    public UpliftDRFV3 validate_upliftdrf(final UpliftDRFParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersUpliftdrf(params.mtries, params.sampleRate, params.treatmentColumn, params.upliftMetric,
                params.auucType, params.auucNbins, params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins, params.nbinsTopLevel,
                params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
                params.histogramType, params.calibrateModel, keyToString(params.calibrationFrame), params.checkConstantResponse,
     ...
     */
    public UpliftDRFV3 grid_search_upliftdrf(final String treatmentColumn) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainUpliftdrf(treatmentColumn).execute().body();
    }

    public UpliftDRFV3 grid_search_upliftdrf(final UpliftDRFParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainUpliftdrf(params.mtries, params.sampleRate, params.treatmentColumn, params.upliftMetric, params.auucType,
                params.auucNbins, params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins, params.nbinsTopLevel,
     ...
     */
    public UpliftDRFV3 grid_search_upliftdrf_resume(final String treatmentColumn) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeUpliftdrf(treatmentColumn).execute().body();
    }

    public UpliftDRFV3 grid_search_upliftdrf_resume(final UpliftDRFParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeUpliftdrf(params.mtries, params.sampleRate, params.treatmentColumn, params.upliftMetric, params.auucType,
                params.auucNbins, params.balanceClasses, params.classSamplingFactors, params.maxAfterBalanceSize,
                params.maxConfusionMatrixSize, params.ntrees, params.maxDepth, params.minRows, params.nbins, params.nbinsTopLevel,
                params.nbinsCats, params.r2Stopping, params.seed, params.buildTreeOneNode, params.sampleRatePerClass,
                params.colSampleRatePerTree, params.colSampleRateChangePerLevel, params.scoreTreeInterval, params.minSplitImprovement,
    ...
    public ModelSelectionV3 train_modelselection(final ModelSelectionParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.trainModelselection(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower, params.theta,
                params.solver, params.alpha, params.lambda, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.scoreIterationInterval, params.standardize, params.coldStart, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.maxIterations, params.betaEpsilon, params.objectiveEpsilon,
                params.gradientEpsilon, params.objReg, params.link, params.startval, params.calcLike, params.mode, params.intercept,
                params.prior, params.lambdaMinRatio, keyToString(params.betaConstraints), params.maxActivePredictors, params.balanceClasses,
                params.classSamplingFactors, params.maxAfterBalanceSize, params.maxConfusionMatrixSize, params.computePValues,
                params.removeCollinearColumns, params.maxPredictorNumber, params.minPredictorNumber, params.nparallelism,
                params.pValuesThreshold, keyToString(params.modelId), keyToString(params.trainingFrame),
                keyToString(params.validationFrame), params.nfolds, params.keepCrossValidationModels, params.keepCrossValidationPredictions,
                params.keepCrossValidationFoldAssignment, params.parallelizeCrossValidation, params.distribution, params.tweediePower,
                params.quantileAlpha, params.huberAlpha, colToString(params.responseColumn), colToString(params.weightsColumn),
                colToString(params.offsetColumn), colToString(params.foldColumn), params.foldAssignment, params.categoricalEncoding,
    ...
    public ModelSelectionV3 validate_modelselection(final ModelSelectionParametersV3 params) throws IOException {
        final ModelBuilders s = getService(ModelBuilders.class);
        return s.validate_parametersModelselection(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower,
                params.theta, params.solver, params.alpha, params.lambda, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.scoreIterationInterval, params.standardize, params.coldStart, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.maxIterations, params.betaEpsilon, params.objectiveEpsilon,
                params.gradientEpsilon, params.objReg, params.link, params.startval, params.calcLike, params.mode, params.intercept,
    ...
    public ModelSelectionV3 grid_search_modelselection(final ModelSelectionParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.trainModelselection(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower, params.theta,
                params.solver, params.alpha, params.lambda, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.scoreIterationInterval, params.standardize, params.coldStart, params.missingValuesHandling,
    ...
    public ModelSelectionV3 grid_search_modelselection_resume(final ModelSelectionParametersV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.resumeModelselection(params.seed, params.family, params.tweedieVariancePower, params.tweedieLinkPower, params.theta,
                params.solver, params.alpha, params.lambda, params.lambdaSearch, params.earlyStopping, params.nlambdas,
                params.scoreIterationInterval, params.standardize, params.coldStart, params.missingValuesHandling,
                keyToString(params.plugValues), params.nonNegative, params.maxIterations, params.betaEpsilon, params.objectiveEpsilon,
                params.gradientEpsilon, params.objReg, params.link, params.startval, params.calcLike, params.mode, params.intercept,
    ...
    public GLMRegularizationPathV3 glm_regularization_path(final GLMRegularizationPathV3 params) throws IOException {
        final GetGLMRegPath s = getService(GetGLMRegPath.class);
        return s.extractRegularizationPath(keyToString(params.model), params.lambdas, params.alphas, params.explainedDevianceTrain,
    ...
    public TreeV3 get_tree(final TreeV3 params) throws IOException {
        final Tree s = getService(Tree.class);
        return s.getTree(keyToString(params.model), params.treeNumber, params.treeClass, params.plainLanguageRules).execute().body();
    }
    ...
    public Call<ImportFilesV3> importFiles(final String path, final String pattern) {
        final ImportFiles s = getService(ImportFiles.class);
        return s.importFiles(path, pattern, "");
    }

    public Call<ImportFilesV3> importFiles(final String path, final String pattern, final String _excludeFields) {
        final ImportFiles s = getService(ImportFiles.class);
        return s.importFiles(path, pattern, _excludeFields);
    }
    ...
    public JobV3 importSqlTable(final ImportSQLTableV99 params) throws IOException {
        ...
        return s.importSQLTable(params.connectionUrl, params.table, params.selectQuery, params.useTempTable, params.tempTableName,
                params.username, params.password, params.columns, params.fetchMode, params.numChunksHint, params._excludeFields).execute()
                .body();
    }
     ...
     */
    public SaveToHiveTableV3 saveToHiveTable(final FrameKeyV3 frameId, final String jdbcUrl, final String tableName) throws IOException {
        final SaveToHiveTable s = getService(SaveToHiveTable.class);
        return s.saveToHiveTable(keyToString(frameId), jdbcUrl, tableName).execute().body();
    }

    public SaveToHiveTableV3 saveToHiveTable(final SaveToHiveTableV3 params) throws IOException {
        final SaveToHiveTable s = getService(SaveToHiveTable.class);
        return s.saveToHiveTable(keyToString(params.frameId), params.jdbcUrl, params.tableName, params.tablePath, params.format,
                params.tmpPath, params._excludeFields).execute().body();
    }
    ...
    public Call<ParseSetupV3> guessParseSetup(final FrameKeyV3[] sourceFrames) {
        ...
        return s.guessSetup(keyArrayToStringArray(sourceFrames));
    }
    ...
    public Call<ParseSetupV3> guessParseSetup(final ParseSetupV3 params) {
        ...
        return s.guessSetup(keyArrayToStringArray(params.sourceFrames), params.parseType, params.separator, params.singleQuotes,
                ...
                params.customNonDataLineMarkers, keyToString(params.decryptTool), params.partitionBy, params.escapechar,
    ...
    public Call<ParseV3> parse(final ParseV3 params) {
        ...
        return s.parse(keyToString(params.destinationFrame), keyArrayToStringArray(params.sourceFrames), params.parseType, params.separator,
                ...
                keyToString(params.decryptTool), params.customNonDataLineMarkers, params.partitionBy, params.escapechar,
                params._excludeFields);
    }
    ...
    public Call<FramesV3> exportFrame(final FramesV3 params) {
        ...
        return s.export(keyToString(params.frameId), params.column, params.rowOffset, params.rowCount, params.columnOffset,
                ...
                params.parallel, params.compression, params.separator, params.header, params.quoteHeader, params._excludeFields);
    }

    /**
     * Save frame data to the given path.
     */
    public FrameSaveV3 saveFrame(final FrameKeyV3 frameId) throws IOException {
        final Frames s = getService(Frames.class);
        return s.save(keyToString(frameId)).execute().body();
    }

    public FrameSaveV3 saveFrame(final FrameSaveV3 params) throws IOException {
        final Frames s = getService(Frames.class);
        return s.save(keyToString(params.frameId), params.dir, params.force, params._excludeFields).execute().body();
    }
    ...
    public FrameLoadV3 loadFrame(final FrameLoadV3 params) throws IOException {
        final Frames s = getService(Frames.class);
        return s.load(keyToString(params.frameId), params.dir, params.force, params._excludeFields).execute().body();
    }
    ...
    public FramesV3 frameColumnDomain(final FramesV3 params) throws IOException {
        ...
        return s.columnDomain(keyToString(params.frameId), params.column, params.rowOffset, params.rowCount, params.columnOffset,
                params.fullColumnCount, params.columnCount, params.findCompatibleModels, params.path, params.force, params.numParts,
                params.parallel, params.compression, params.separator, params.header, params.quoteHeader, params._excludeFields).execute()
                .body();
    }
    ...
    public Call<FramesV3> frameSummary(final FrameKeyV3 frameId) {
        final Frames s = getService(Frames.class);
        return s.summary(keyToString(frameId));
    }
    ...
    public Call<ModelsV3> model(final ModelsV3 params) {
        final Models s = getService(Models.class);
        return s.fetch(keyToString(params.modelId), params.preview, params.findCompatibleFrames, params.exportCrossValidationPredictions,
                params._excludeFields);
    }
    ...
    public Call<ModelsV3> models(final ModelsV3 params) {
        final Models s = getService(Models.class);
        return s.list(keyToString(params.modelId), params.preview, params.findCompatibleFrames, params.exportCrossValidationPredictions,
                params._excludeFields);
    }
    ...
    public Call<ModelsV3> deleteModel(final ModelsV3 params) {
        final Models s = getService(Models.class);
        return s.delete(keyToString(params.modelId), params.preview, params.findCompatibleFrames, params.exportCrossValidationPredictions,
                params._excludeFields);
    }
    ...
    public ModelsV3 deleteAllModels(final ModelsV3 params) throws IOException {
        final Models s = getService(Models.class);
        return s.deleteAll(keyToString(params.modelId), params.preview, params.findCompatibleFrames,
                params.exportCrossValidationPredictions, params._excludeFields).execute().body();
    }
    ...
    public StreamingSchema modelPreview(final ModelsV3 params) throws IOException {
        final Models s = getService(Models.class);
        return s.fetchPreview(keyToString(params.modelId), params.preview, params.findCompatibleFrames,
                params.exportCrossValidationPredictions, params._excludeFields).execute().body();
    }
    ...
    public StreamingSchema modelJavaCode(final ModelsV3 params) throws IOException {
        final Models s = getService(Models.class);
        return s.fetchJavaCode(keyToString(params.modelId), params.preview, params.findCompatibleFrames,
                params.exportCrossValidationPredictions, params._excludeFields).execute().body();
    }
    ...
    public Call<StreamingSchema> modelMojo(final ModelsV3 params) {
        final Models s = getService(Models.class);
        return s.fetchMojo(keyToString(params.modelId), params.preview, params.findCompatibleFrames,
                params.exportCrossValidationPredictions, params._excludeFields);
    }

    /**
     * Return the model in the binary format.
     */
    public StreamingSchema modelBinary(final ModelKeyV3 modelId) throws IOException {
        final Models s = getService(Models.class);
        return s.fetchBinaryModel(keyToString(modelId)).execute().body();
    }

    public StreamingSchema modelBinary(final ModelsV3 params) throws IOException {
        final Models s = getService(Models.class);
        return s.fetchBinaryModel(keyToString(params.modelId), params.preview, params.findCompatibleFrames,
                params.exportCrossValidationPredictions, params._excludeFields).execute().body();
    }
    ...
    public JobV3 makePDP(final PartialDependenceV3 params) throws IOException {
        ...
        return s.makePartialDependence(keyToString(params.modelId), keyToString(params.frameId), params.rowIndex, params.cols,
                ...
                params.colPairs2dpdp, keyToString(params.destinationKey), params.targets).execute().body();
    }

    /**
     * Fetch feature interaction data
     */
    public FeatureInteractionV3 makeFI(final int maxInteractionDepth, final int maxTreeDepth, final int maxDeepening) throws IOException {
        final FeatureInteraction s = getService(FeatureInteraction.class);
        return s.makeFeatureInteraction(maxInteractionDepth, maxTreeDepth, maxDeepening).execute().body();
    }

    public FeatureInteractionV3 makeFI(final FeatureInteractionV3 params) throws IOException {
        final FeatureInteraction s = getService(FeatureInteraction.class);
        return s.makeFeatureInteraction(keyToString(params.modelId), params.maxInteractionDepth, params.maxTreeDepth, params.maxDeepening,
                params._excludeFields).execute().body();
    }
     ...
     */
    public FriedmanPopescusHV3 makeH(final FrameV3 frame, final String[] variables) throws IOException {
        final FriedmansPopescusH s = getService(FriedmansPopescusH.class);
        return s.makeFriedmansPopescusH(frame, variables).execute().body();
    }

    public FriedmanPopescusHV3 makeH(final FriedmanPopescusHV3 params) throws IOException {
        final FriedmansPopescusH s = getService(FriedmansPopescusH.class);
        return s.makeFriedmansPopescusH(keyToString(params.modelId), params.frame, params.variables, params.h, params._excludeFields)
                .execute().body();
    }
    ...
    public Call<ModelExportV3> exportModel(final ModelExportV3 params) {
        final Models s = getService(Models.class);
        return s.exportModel(keyToString(params.modelId), params.dir, params.force, params.exportCrossValidationPredictions,
                params._excludeFields);
    }
     ...
     */
    public ModelsV3 uploadModel(final ModelKeyV3 modelId) throws IOException {
        final Models s = getService(Models.class);
        return s.uploadModel(keyToString(modelId)).execute().body();
    }

    public ModelsV3 uploadModel(final ModelImportV3 params) throws IOException {
        final Models s = getService(Models.class);
        return s.uploadModel(keyToString(params.modelId), params.dir, params.force, params._excludeFields).execute().body();
    }
    ...
    public ModelExportV3 exportMojo(final ModelExportV3 params) throws IOException {
        final Models s = getService(Models.class);
        return s.exportMojo(keyToString(params.modelId), params.dir, params.force, params.exportCrossValidationPredictions,
                params._excludeFields).execute().body();
    }
    ...
    public ModelExportV3 exportModelDetails(final ModelExportV3 params) throws IOException {
        final Models s = getService(Models.class);
        return s.exportModelDetails(keyToString(params.modelId), params.dir, params.force, params.exportCrossValidationPredictions,
                params._excludeFields).execute().body();
    }
    ...
    public ModelMetricsListSchemaV3 _mmFetch1(final ModelMetricsListSchemaV3 params) throws IOException {
        ...
        return s.fetch(keyToString(params.model), keyToString(params.frame), keyToString(params.predictionsFrame),
                ...
                params.predictContributions, params.predictContributionsOutputFormat, params.topN, params.bottomN, params.compareAbs,
                params.featureFrequencies, params.exemplarIndex, params.deviances, params.customMetricFunc, params.aucType, params.auucType,
                params.auucNbins, params._excludeFields).execute().body();
    }
    ...
    public Call<ModelMetricsListSchemaV3> predict(final ModelMetricsListSchemaV3 params) {
        ...
        return s.predict(keyToString(params.model), keyToString(params.frame), keyToString(params.predictionsFrame),
                ...
                params.predictContributions, params.predictContributionsOutputFormat, params.topN, params.bottomN, params.compareAbs,
                params.featureFrequencies, params.exemplarIndex, params.deviances, params.customMetricFunc, params.aucType, params.auucType,
                params.auucNbins, params._excludeFields);
    }
    ...
    public ModelMetricsMakerSchemaV3 makeMetrics(final ModelMetricsMakerSchemaV3 params) throws IOException {
        final ModelMetrics s = getService(ModelMetrics.class);
        return s.make(params.predictionsFrame, params.actualsFrame, params.weightsFrame, params.treatmentFrame, params.domain,
                params.distribution, params.aucType, params.auucType, params.auucNbins).execute().body();
    }
    ...
    public SessionPropertyV3 setSessionProperty() throws IOException {
        final SessionProperties s = getService(SessionProperties.class);
        return s.setSessionProperty().execute().body();
    }

    public SessionPropertyV3 setSessionProperty(final SessionPropertyV3 params) throws IOException {
        final SessionProperties s = getService(SessionProperties.class);
        return s.setSessionProperty(params.sessionKey, params.key, params.value, params._excludeFields).execute().body();
    }
    ...
    public SessionPropertyV3 getSessionProperty(final SessionPropertyV3 params) throws IOException {
        final SessionProperties s = getService(SessionProperties.class);
        return s.getSessionProperty(params.sessionKey, params.key, params.value, params._excludeFields).execute().body();
    }
    ...
    public GridKeyV3 import_grid(final String gridPath, final boolean loadParamsReferences) throws IOException {
        final Grid s = getService(Grid.class);
    ...
    public GridKeyV3 export_grid(final GridExportV3 params) throws IOException {
        final Grid s = getService(Grid.class);
        return s.exportGrid(params.gridId, params.gridDirectory, params.saveParamsReferences, params.exportCrossValidationPredictions)
                .execute().body();
    }
    ...
    public ResumeV3 recovery_resume() throws IOException {
        final Recovery s = getService(Recovery.class);
        return s.resume().execute().body();
    }

    public ResumeV3 recovery_resume(final String recoveryDir) throws IOException {
        final Recovery s = getService(Recovery.class);
    ...
    private void initializeRetrofit() {
        ...
        final Builder builder = new OkHttpClient.Builder().connectTimeout(connectTimeout, TimeUnit.SECONDS)
    ...
    private static class KeySerializer implements JsonSerializer<KeyV3>, JsonDeserializer<KeyV3> {
        ...
        public KeyV3 deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context) {
            ...
            return switch (type) {
            case "Key<Model>" -> context.deserialize(jsonObj, ModelKeyV3.class);
            case "Key<Models>" -> context.deserialize(jsonObj, ModelsKeyV3.class);
            case "Key<Job>" -> context.deserialize(jsonObj, JobKeyV3.class);
            case "Key<Grid>" -> context.deserialize(jsonObj, GridKeyV3.class);
            case "Key<Frame>" -> context.deserialize(jsonObj, FrameKeyV3.class);
            case "Key<AutoML>" -> context.deserialize(jsonObj, AutoMLKeyV3.class);
            case "Key<DecryptionTool>" -> context.deserialize(jsonObj, DecryptionToolKeyV3.class);
            case "Key<Assembly>" -> context.deserialize(jsonObj, AssemblyKeyV3.class);
            case "Key<SegmentModels>" -> context.deserialize(jsonObj, SegmentModelsKeyV3.class);
            case "Key<PartialDependence>" -> context.deserialize(jsonObj, PartialDependenceKeyV3.class);
            default -> throw new JsonParseException("Unable to deserialize key of type " + type + " : " + jsonObj);
            };
        }
    }
        ...
        public ModelBuilderSchema deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    ...
                    return switch (algo) {
                    case "xgboost" -> context.deserialize(json, XGBoostV3.class);
                    case "infogram" -> context.deserialize(json, InfogramV3.class);
                    case "targetencoder" -> context.deserialize(json, TargetEncoderV3.class);
                    case "deeplearning" -> context.deserialize(json, DeepLearningV3.class);
                    case "glm" -> context.deserialize(json, GLMV3.class);
                    case "glrm" -> context.deserialize(json, GLRMV3.class);
                    case "kmeans" -> context.deserialize(json, KMeansV3.class);
                    case "naivebayes" -> context.deserialize(json, NaiveBayesV3.class);
                    case "pca" -> context.deserialize(json, PCAV3.class);
                    case "svd" -> context.deserialize(json, SVDV99.class);
                    case "drf" -> context.deserialize(json, DRFV3.class);
                    case "gbm" -> context.deserialize(json, GBMV3.class);
                    case "isolationforest" -> context.deserialize(json, IsolationForestV3.class);
                    case "extendedisolationforest" -> context.deserialize(json, ExtendedIsolationForestV3.class);
                    case "aggregator" -> context.deserialize(json, AggregatorV99.class);
                    case "word2vec" -> context.deserialize(json, Word2VecV3.class);
                    case "stackedensemble" -> context.deserialize(json, StackedEnsembleV99.class);
                    case "coxph" -> context.deserialize(json, CoxPHV3.class);
                    case "generic" -> context.deserialize(json, GenericV3.class);
                    case "gam" -> context.deserialize(json, GAMV3.class);
                    case "anovaglm" -> context.deserialize(json, ANOVAGLMV3.class);
                    case "psvm" -> context.deserialize(json, PSVMV3.class);
                    case "rulefit" -> context.deserialize(json, RuleFitV3.class);
                    case "upliftdrf" -> context.deserialize(json, UpliftDRFV3.class);
                    case "modelselection" -> context.deserialize(json, ModelSelectionV3.class);
                    default -> throw new JsonParseException("Unable to deserialize model of type " + algo);
                    };
                }
            }
        ...
        public ModelSchemaBaseV3 deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    final String algo = jobj.get("algo").getAsJsonPrimitive().getAsString().toLowerCase();
                    return switch (algo) {
                    case "xgboost" -> context.deserialize(json, XGBoostModelV3.class);
                    case "infogram" -> context.deserialize(json, InfogramModelV3.class);
                    case "targetencoder" -> context.deserialize(json, TargetEncoderModelV3.class);
                    case "deeplearning" -> context.deserialize(json, DeepLearningModelV3.class);
                    case "glm" -> context.deserialize(json, GLMModelV3.class);
                    case "glrm" -> context.deserialize(json, GLRMModelV3.class);
                    case "kmeans" -> context.deserialize(json, KMeansModelV3.class);
                    case "naivebayes" -> context.deserialize(json, NaiveBayesModelV3.class);
                    case "pca" -> context.deserialize(json, PCAModelV3.class);
                    case "svd" -> context.deserialize(json, SVDModelV99.class);
                    case "drf" -> context.deserialize(json, DRFModelV3.class);
                    case "gbm" -> context.deserialize(json, GBMModelV3.class);
                    case "isolationforest" -> context.deserialize(json, IsolationForestModelV3.class);
                    case "extendedisolationforest" -> context.deserialize(json, ExtendedIsolationForestModelV3.class);
                    case "aggregator" -> context.deserialize(json, AggregatorModelV99.class);
                    case "word2vec" -> context.deserialize(json, Word2VecModelV3.class);
                    case "stackedensemble" -> context.deserialize(json, StackedEnsembleModelV99.class);
                    case "coxph" -> context.deserialize(json, CoxPHModelV3.class);
                    case "generic" -> context.deserialize(json, GenericModelV3.class);
                    case "gam" -> context.deserialize(json, GAMModelV3.class);
                    case "anovaglm" -> context.deserialize(json, ANOVAGLMModelV3.class);
                    case "psvm" -> context.deserialize(json, PSVMModelV3.class);
                    case "rulefit" -> context.deserialize(json, RuleFitModelV3.class);
                    case "upliftdrf" -> context.deserialize(json, UpliftDRFModelV3.class);
                    case "modelselection" -> context.deserialize(json, ModelSelectionModelV3.class);
                    default -> throw new JsonParseException("Unable to deserialize model of type " + algo);
                    };
                }
            }
        ...
        public ModelOutputSchemaV3 deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    final String algo = jobj.get("algo").getAsJsonPrimitive().getAsString().toLowerCase();
                    return switch (algo) {
                    case "xgboost" -> context.deserialize(json, XGBoostModelOutputV3.class);
                    case "infogram" -> context.deserialize(json, InfogramModelOutputV3.class);
                    case "targetencoder" -> context.deserialize(json, TargetEncoderModelOutputV3.class);
                    case "deeplearning" -> context.deserialize(json, DeepLearningModelOutputV3.class);
                    case "glm" -> context.deserialize(json, GLMModelOutputV3.class);
                    case "glrm" -> context.deserialize(json, GLRMModelOutputV3.class);
                    case "kmeans" -> context.deserialize(json, KMeansModelOutputV3.class);
                    case "naivebayes" -> context.deserialize(json, NaiveBayesModelOutputV3.class);
                    case "pca" -> context.deserialize(json, PCAModelOutputV3.class);
                    case "svd" -> context.deserialize(json, SVDModelOutputV99.class);
                    case "drf" -> context.deserialize(json, DRFModelOutputV3.class);
                    case "gbm" -> context.deserialize(json, GBMModelOutputV3.class);
                    case "isolationforest" -> context.deserialize(json, IsolationForestModelOutputV3.class);
                    case "extendedisolationforest" -> context.deserialize(json, ExtendedIsolationForestModelOutputV3.class);
                    case "aggregator" -> context.deserialize(json, AggregatorModelOutputV99.class);
                    case "word2vec" -> context.deserialize(json, Word2VecModelOutputV3.class);
                    case "stackedensemble" -> context.deserialize(json, StackedEnsembleModelOutputV99.class);
                    case "coxph" -> context.deserialize(json, CoxPHModelOutputV3.class);
                    case "generic" -> context.deserialize(json, GenericModelOutputV3.class);
                    case "gam" -> context.deserialize(json, GAMModelOutputV3.class);
                    case "anovaglm" -> context.deserialize(json, ANOVAGLMModelOutputV3.class);
                    case "psvm" -> context.deserialize(json, PSVMModelOutputV3.class);
                    case "rulefit" -> context.deserialize(json, RuleFitModelOutputV3.class);
                    case "upliftdrf" -> context.deserialize(json, UpliftDRFModelOutputV3.class);
                    case "modelselection" -> context.deserialize(json, ModelSelectionModelOutputV3.class);
                    default -> throw new JsonParseException("Unable to deserialize model of type " + algo);
                    };
                }
            }
        ...
        public ModelParametersSchemaV3 deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
            ...
            if (json.isJsonObject()) {
                ...
                if (jobj.has("algo")) {
                    final String algo = jobj.get("algo").getAsJsonPrimitive().getAsString().toLowerCase();
                    return switch (algo) {
                    case "xgboost" -> context.deserialize(json, XGBoostParametersV3.class);
                    case "infogram" -> context.deserialize(json, InfogramParametersV3.class);
                    case "targetencoder" -> context.deserialize(json, TargetEncoderParametersV3.class);
                    case "deeplearning" -> context.deserialize(json, DeepLearningParametersV3.class);
                    case "glm" -> context.deserialize(json, GLMParametersV3.class);
                    case "glrm" -> context.deserialize(json, GLRMParametersV3.class);
                    case "kmeans" -> context.deserialize(json, KMeansParametersV3.class);
                    case "naivebayes" -> context.deserialize(json, NaiveBayesParametersV3.class);
                    case "pca" -> context.deserialize(json, PCAParametersV3.class);
                    case "svd" -> context.deserialize(json, SVDParametersV99.class);
                    case "drf" -> context.deserialize(json, DRFParametersV3.class);
                    case "gbm" -> context.deserialize(json, GBMParametersV3.class);
                    case "isolationforest" -> context.deserialize(json, IsolationForestParametersV3.class);
                    case "extendedisolationforest" -> context.deserialize(json, ExtendedIsolationForestParametersV3.class);
                    case "aggregator" -> context.deserialize(json, AggregatorParametersV99.class);
                    case "word2vec" -> context.deserialize(json, Word2VecParametersV3.class);
                    case "stackedensemble" -> context.deserialize(json, StackedEnsembleParametersV99.class);
                    case "coxph" -> context.deserialize(json, CoxPHParametersV3.class);
                    case "generic" -> context.deserialize(json, GenericParametersV3.class);
                    case "gam" -> context.deserialize(json, GAMParametersV3.class);
                    case "anovaglm" -> context.deserialize(json, ANOVAGLMParametersV3.class);
                    case "psvm" -> context.deserialize(json, PSVMParametersV3.class);
                    case "rulefit" -> context.deserialize(json, RuleFitParametersV3.class);
                    case "upliftdrf" -> context.deserialize(json, UpliftDRFParametersV3.class);
                    case "modelselection" -> context.deserialize(json, ModelSelectionParametersV3.class);
                    default -> throw new JsonParseException("Unable to deserialize model of type " + algo);
                    };
                }
            }
