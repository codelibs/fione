...
import org.codelibs.fione.h2o.bindings.pojos.ImportFilesMultiV3;
...
public interface ImportFilesMulti {
    ...
    Call<ImportFilesMultiV3> importFilesMulti(@Field("paths") String[] paths, @Field("pattern") String pattern,
